...
class TensorVMSplit(TensorBase):
    ...
    def half(self):
        fn_ = torch.nn.AvgPool2d(2, stride=2)
        self.density_plane[0] = fn_(self.density_plane[0])
        self.density_plane[1] = fn_(self.density_plane[1])
        self.density_plane[2] = fn_(self.density_plane[2])
        
        self.app_plane[0] = fn_(self.app_plane[0])
        self.app_plane[1] = fn_(self.app_plane[1])
        self.app_plane[2] = fn_(self.app_plane[2])
        
        fn_l = torch.nn.AvgPool1d(2, stride=2)
        self.density_line[0] = fn_l(self.density_line[0][...,0])[...,None]
        self.density_line[1] = fn_l(self.density_line[1][...,0])[...,None]
        self.density_line[2] = fn_l(self.density_line[2][...,0])[...,None]
        
        
        self.app_line[0] = fn_l(self.app_line[0][...,0])[...,None]
        self.app_line[1] = fn_l(self.app_line[1][...,0])[...,None]
        self.app_line[2] = fn_l(self.app_line[2][...,0])[...,None]
